  ...
  return (
    <div className="card docs">
      ...
      <p>
        ...
        <Link className="font-medium hover:underline" target={'_blank'} to="https://github.com/primefaces/primeicons">
          PrimeIcons
        </Link>
        library, the official icons suite from{' '}
        <Link className="font-medium hover:underline" target={'_blank'} to="https://www.primetek.com.tr">
          PrimeTek
        </Link>
        .
      </p>
