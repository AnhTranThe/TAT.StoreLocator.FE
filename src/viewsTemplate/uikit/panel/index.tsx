          ...
          <Accordion activeIndex={0}>
            ...
            <AccordionTab header="Header III">
              <p>
                ...
                dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus.
              </p>
            </AccordionTab>
          </Accordion>
        </div>
          ...
          <div className="grid">
            ...
            <div className="col-5 align-items-center justify-content-center">
              ...
              <p>
                ...
                doloribus asperiores repellat. Donec vel volutpat ipsum. Integer nunc magna, posuere ut tincidunt eget, egestas vitae sapien. Morbi dapibus luctus odio.
              </p>
            </div>
          </div>
        </div>
